from activities.views import reports, MarcaView, RespuestaSeleccionMultipleView, \
    DetailPreguntaSeleccionMultiple, CreatePreguntaAbierta, CreatePreguntaSeleccionMultiple
